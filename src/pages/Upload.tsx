...
export default function UploadPage() {
  ...
  const [showRater2, setShowRater2] = React.useState(false);
  const [raterInfo, setRaterInfo] = React.useState({
    rater1_first_name: "",
    rater1_last_name: "",
    rater1_suffix: "",
    rater2_first_name: "",
  ...
  const [userCustomDescriptors, setUserCustomDescriptors] = React.useState([]);
  const [selectedScores, setSelectedScores] = React.useState(new Set());

  const [isUploading, setIsUploading] = React.useState(false);
  const [isProcessing, setIsProcessing] = React.useState(false);
  const [isSaving, setIsSaving] = React.useState(false);
  const [hasProcessedFiles, setHasProcessedFiles] = React.useState(false);
  ...
  const validationSchema = z.object({
    ...
    subjective_pronoun: z.string().min(1, "Subjective pronoun is required"),
    objective_pronoun: z.string().min(1, "Objective pronoun is required"),
    possessive_pronoun: z.string().min(1, "Possessive pronoun is required"),
    test_date: z.string().min(1, "Test date is required"),
    rater1_first_name: z.string().min(1, "Rater 1 first name is required"),
    rater1_last_name: z.string().min(1, "Rater 1 last name is required"),
    rater1_suffix: z.string().min(1, "Rater 1 suffix is required"),
    rater2_first_name: z.string().min(1, "Rater 2 first name is required"),
    rater2_last_name: z.string().min(1, "Rater 2 last name is required"),
    rater2_suffix: z.string().min(1, "Rater 2 suffix is required"),
  });
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <GridItem> {isProcessing && <ProcessingCard />}</GridItem>
          </Form>
