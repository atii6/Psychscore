...
function StandardScoreDescriptorTable({
  ...
  return (
    <>
      <CustomContentCard
        title="My Standard Score Descriptors"
        description="Custom descriptors for standard scores (Mean = 100, SD = 15)"
...
export default StandardScoreDescriptorTable;
