...
export default function FileUploadZone({ onFileSelect, isUploading, disabled }) {
  ...
  return (
    <Card className="border-0 shadow-lg rounded-2xl" style={{backgroundColor: 'var(--card-background)'}}>
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-xl" style={{color: 'var(--text-primary)'}}>
          <Upload className="w-6 h-6" style={{color: 'var(--secondary-blue)'}} />
        ...
        >
          {isUploading ? (
            <div className="flex flex-col items-center gap-4">
              <Loader2 className="w-12 h-12 animate-spin" style={{color: 'var(--secondary-blue)'}} />
            ...
            <>
              <div className="flex justify-center items-center gap-4 mb-6">
                <FileText className="w-12 h-12" style={{color: 'var(--secondary-blue)'}} />
                <ImageIcon className="w-12 h-12" style={{color: 'var(--secondary-blue)'}} />
                <Camera className="w-12 h-12" style={{color: 'var(--secondary-blue)'}} />
              </div>
